...
public class Intervention extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Intervention frame = new Intervention();
	...
	public Intervention() {
		...
		list.setBounds(117, 78, 138, 142);
		contentPane.add(list);
		
		JLabel lblNewLabel = new JLabel("Intervention");
		lblNewLabel.setForeground(new Color(255, 0, 0));
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 20));
		lblNewLabel.setBounds(167, 11, 161, 40);
		...
		btnNewButton_1.setBounds(220, 227, 89, 23);
